...
.play-box
	...
	c-button(:disabled="true") 按钮
	c-button(type="primary" :disabled="true") 按钮
	h2 c-color
	c-color(v-model="color1")
	c-color(v-model="color2" :disabled="true")
	h2 c-input
	...
	c-input(width="152px", v-model="input1", icon-append="checkmark")
	h2 c-label
	c-label 标签
	h2 c-svg
	...
	c-collapse(label="基础属性", v-model="collapse1" type="eye" :enable="enable1" @open-click="enable1=true" @close-click="enable1=false")
		h2 c-tooltip
	...
	c-tabs(v-model="tab")
		c-tab-pane(label="sss" :value="1")
			c-button 1
		c-tab-pane(label="bbb" :value="2")
			div 2
	c-tabs(v-model="tab")
		c-tab-pane(label="sss" :value="1")
			c-button 1
